...
function LocalPagination({total, page, pageSize, funcSetPaginationPage, funcSetPaginationPageSize}) {
    ...
    >
        {({
            ...
            <div className="pagination pagination-sm justify-content-center">
                ...
                <select className="page-item" placeholder="limit" value={pageSize} onChange={handleChangeLimit}>
...
export default connect(mapStateToProps, mapDispatchtoProps)(LocalPagination);